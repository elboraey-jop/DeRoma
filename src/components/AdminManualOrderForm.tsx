      ...
      {open && (
        <div className="absolute inset-x-0 top-[calc(100%+0.35rem)] z-30 overflow-hidden rounded-2xl border border-[#eadfd6] bg-[#fffdfa] p-2 shadow-xl">
          ...
          <div
            ...
            style={{ maxHeight: "12rem", WebkitOverflowScrolling: "touch" }}
            className="hide-scrollbar mt-2 max-h-48 overflow-y-auto overscroll-contain touch-pan-y"
          >
            {filtered.map((item) => (
