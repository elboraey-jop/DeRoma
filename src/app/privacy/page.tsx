  ...
  return (
    <div className="min-h-screen bg-[#FFF9EB] text-[#942E3A] font-outfit py-12 px-4 sm:px-6 lg:px-8" dir="ltr">
      <div className="max-w-[800px] mx-auto space-y-10">
        ...
        {/* Navigation */}
        <div>
          <Link href="/" className="inline-flex items-center gap-1 text-xs font-bold text-[#942E3A] hover:text-[#942E3A] transition-colors">
        ...
        <section className="space-y-3">
          <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-[#942E3A]">Trust & Security</span>
        ...
        {/* Content Box */}
        <section className="bg-white border border-[#942E3A]/30 rounded-3xl p-6 sm:p-10 space-y-8 shadow-xs">
          
          {/* Section 1 */}
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <ShieldCheck className="w-5 h-5 text-[#942E3A]" />
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <Lock className="w-5 h-5 text-[#942E3A]" />
              <h2 className="text-lg font-bold text-[#942E3A] font-playfair">2. Data Protection</h2>
            </div>
            <p className="text-xs sm:text-sm text-[#6B1F2A] font-light leading-relaxed">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <EyeOff className="w-5 h-5 text-[#942E3A]" />
              <h2 className="text-lg font-bold text-[#942E3A] font-playfair">3. Cookies & Tracking</h2>
            </div>
            <p className="text-xs sm:text-sm text-[#6B1F2A] font-light leading-relaxed">
          ...
          {/* Section 4 */}
          <div className="space-y-3 pt-4 border-t border-[#942E3A]/20">
            <h2 className="text-base font-bold text-[#942E3A]">Contact Our Privacy Team</h2>
            <p className="text-xs sm:text-sm text-[#6B1F2A] font-light leading-relaxed">
              If you have any questions about how we handle your personal data, or if you would like to request data deletion, please contact us at <span className="font-bold text-[#942E3A]">privacy@deromashoes.com</span>.
            </p>
          </div>
