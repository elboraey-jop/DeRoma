...
export default async function NewPurchaseInvoicePage() {
  ...
  return <div className="mx-auto max-w-6xl space-y-5"><div className="flex items-center gap-3"><AdminBackButton fallbackHref="/admin/suppliers" /><div><p className="text-[10px] font-bold uppercase tracking-[0.25em] text-[#D8B46A]">Procurement</p><h1 className="mt-1 font-playfair text-3xl font-black">Create purchase invoice</h1><p className="mt-1 text-xs text-[#6B1F2A]/65">Receive stock, preserve cost history, and keep supplier balances accurate.</p></div></div><AdminPurchaseInvoiceForm suppliers={suppliers} variants={variants} /></div>;
}
