  ...
  return (
    <div className="mx-auto max-w-6xl space-y-5">
      ...
      <section className="rounded-3xl border border-[#942E3A]/10 bg-white p-5 shadow-sm sm:p-7">
        ...
        <div className="mt-5 rounded-2xl bg-[#FFF9EB] p-4 text-xs text-[#6B1F2A]/75"><p>Total: <strong>{formatCurrency(Number(invoice.total))}</strong> · Balance: <strong>{formatCurrency(balance)}</strong></p></div>
      </section>
    </div>
  );
}
